game.PlayScreen = me.ScreenObject.extend({
    ...
    eventDrivenSetup: function() {
        ...
        for (i = 0; i < numTasks * 2; i++) {
            ...
            game.AVAILABLE_POSITIONS.tasks.push(new Point((i % numTasks) * game.STORY_SHIP.width, game.PADDING + game.MOTHERSHIP.height+ game.FEATURE_SHIP.height + game.STORY_SHIP.height * 3 + game.TASK_SHIP.height * Math.floor(i/numTasks)));
        }
    ...
    addFeature: function(record, oid, date) {
        //if (this.numFeatures < 10) {
            ...
            console.log('no room for feature!', game.AVAILABLE_POSITIONS);
            }
        //}
    },
    ...
    addStory: function(record, oid, date) {
        ...
        if (point) {
            ...
            console.log('no room for story!', game.AVAILABLE_POSITIONS);
        }
    },
    ...
    addTask: function(record, oid, date) {
        ...
        if (point) {
            ...
            console.log('no room for task!', game.AVAILABLE_POSITIONS);
        }
    },
    ...
    recycleShip: function(oid, date) {
        ...
        if (obj && obj.displayed && obj.ship) {
            ...
            // TODO add back this point as available
            console.log("recycling", ship, ship.type);
